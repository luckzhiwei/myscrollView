...
public class DetailRootLayout  extends LinearLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        ViewGroup.LayoutParams viewPagerLayoutParams=this.viewPagerDetail2ShowDetial.getLayoutParams();
        viewPagerLayoutParams.height=this.getMeasuredHeight()-this.relLayoutDetialLayoutDetial.getMeasuredHeight();
    }
}
